...
class FieldFillingValidator:
    def __init__(self, reward, related_habit, pleasure_habit):
        self.reward = reward
        self.related_habit = related_habit
        self.pleasure_habit = pleasure_habit

    def __call__(self, value):
        reward_field = value.get(self.reward)
        related_habit_field = value.get(self.related_habit)
        sign_of_a_pleasant_habit_field = value.get(self.pleasure_habit)
